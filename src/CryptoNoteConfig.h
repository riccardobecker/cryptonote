...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7af9;
...
const char     CRYPTONOTE_NAME[]                             = "IOTC";
...
const int      P2P_DEFAULT_PORT                              = 47821;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 48821;
